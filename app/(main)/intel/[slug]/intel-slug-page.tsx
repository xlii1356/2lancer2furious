...
export default async function IntelEntryPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <article>
      ...
      {entry.imageUrl && (
        <Image src={entry.imageUrl} alt={entry.name} width={240} height={240} className="float-left mr-6 mb-4 mt-6 w-48 border border-separator object-cover sm:w-60" unoptimized />
      )}
