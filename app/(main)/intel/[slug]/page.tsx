import Link from "next/link"; import Image from "next/image"; import { notFound } from "next/navigation"; import { db } from "@/db"; import { intelEntries, intelNotes, users } from "@/db/schema"; import { eq } from "drizzle-orm"; import { getOptionalUser } from "@/app/actions/helpers"; import { deleteIntelEntry } from "@/app/actions/intel"; import { saveIntelNotes } from "@/app/actions/intelNotes"; import { TiptapRenderer } from "@/components/TiptapRenderer"; import { RichTextEditor } from "@/components/RichTextEditor"; import { NotesToggle } from "@/components/NotesToggle"; import { DeleteButton } from "@/components/DeleteButton"; import { scaledImageSrc } from "@/lib/imageScale";
...
export default async function IntelEntryPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <article>
      ...
      <section className="mt-10 clear-both border-t border-separator pt-6">
        ...
        {user ? (
          ...
          <p className="mt-3 text-text-mid">
            No notes yet — <Link className="text-primary" href="/signin">log in</Link> to add some.
          </p>
        )}
      </section>
    </article>
