...
export default async function SignInPage({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return (
    <main className="mx-auto mt-24 max-w-md px-5">
      <Link href="/" className="font-eyebrow text-xs font-bold uppercase tracking-[0.15em] text-text-mid hover:text-primary">← Back to site</Link>
      <h1 className="mt-4 font-display text-3xl font-extrabold uppercase tracking-wide text-text-hi">Establishing Uplink...</h1>
      <p className="mt-3 text-text-mid">Please verify pilot credentials, or <Link href="/" className="text-primary">continue browsing without an account</Link>.</p>
